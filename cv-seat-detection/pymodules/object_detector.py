    ...
    def processFrame(self, image):
        ...
        for output in layerOutputs:
            ...
            for detection in output:
                ...
                if confidence > OBJ_DETECTION_CONFIDENCE:
        ...
        # # bounding boxes
        # idxs = cv2.dnn.NMSBoxes(boxes, confidences, OBJ_DETECTION_CONFIDENCE,
        #     NON_MAXIMA_THRESHOLD)
