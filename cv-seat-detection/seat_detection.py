...
def _parse_args():
    ...
    parser.add_argument("--pretrained-model", type=str, default="models/faster_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb",
...
def main(args):
    ...
    VIDEO_1_FRAME_COUNT = 525.0 #Dont Understand
    VIDEO_2_FRAME_COUNT = TOTAL_FRAME_COUNT - VIDEO_1_FRAME_COUNT #Dont Understand
