define(['jquery', 'underscore', 'backbone', 'text!template/other_international.html'], function ($, _, Backbone, template) {
    return Backbone.View.extend({
        ...
        render: function () {
            this.$el.html(_.template(this.template));
                ...
                var img = new Image($('#chart').width());
                img.onload = function () {
                    // console.log($(img).css('width', '100%'))
